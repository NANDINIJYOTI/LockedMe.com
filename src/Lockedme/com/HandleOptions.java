...
//Writing a program in Java to handle Menu options selected by user
import java.util.List;
import java.util.Scanner;
public class HandleOptions {
//Writing method to handle user input in initial Menu
...
//Writing method to handle user input in Secondary Menu for File Operations
